...
| `bible.jpg` | Библия | есть |
| `prayers.jpg` | Молитвы | есть |
| `calendar.jpg` | Календарь | есть |
| `more.jpg` | Ещё | есть |

Если какой-то файл удалить, вместо «битой картинки» автоматически показывается
аккуратная CSS-заглушка «Скриншот скоро появится».

Чтобы заменить скриншот: сохраните JPEG с точным именем из таблицы (рекомендуемая
